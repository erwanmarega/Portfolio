<template>
  <div
    class="w-full relative bg-gray-100 flex flex-col lg:flex-row min-h-screen overflow-hidden"
    ref="stackArea"
  >
    <div
    ...
    >
      <div class="flex flex-col items-center space-y-6">
        ...
        >
          <a :href="CV_Marega" target="_blank" class="button">
            <span class="text">Téléchargez mon CV !</span>
          </a>
          <a :href="Portfolio" target="_blank" class="button">
